...
banner() {
    ...
    toilet -f ivrit 'DHK_Tn' | boxes -d cat -a hc -p h8 | lolcat
    else
    cowsay 'DHK_Tn' | lolcat
    fi
    echo 'This Bomber Was Created By DHK' | lolcat
    echo 'For Any Queries Contact Me!!!'| lolcat
    echo 'Intagram:- tarek dgh'| lolcat
    echo ' '| lolcat
...
if [ -f .update ];then
    ...
    install_deps
    echo 'This Script Was Made By DHK Tn' > .update
...
do
	...
	echo -e "\e[4;34m This Bomber Was Created DHK_Tn \e[0m" | lolcat
	echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
	echo -e "\e[1;32m   Intagram:- tarek dgh\e[0m"| lolcat
	echo -e "\e[4;32m   Whatsapp: +15046034501 \e[0m"| lolcat
        exit
    elif [ $ch -eq 0 ];then
        banner
        exit
